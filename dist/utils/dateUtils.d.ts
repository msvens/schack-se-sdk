 ...
 */
export declare function getMonthStart(timestamp: number): number;
/**
 ...
 */
export declare function getMonthStartString(timestamp: number): string;
/**
 ...
 */
export declare function normalizeEloLookupDate(timestamp: number): number;
/**
 ...
 * // -> "12345-2026-01-01"
 */
export declare function getPlayerDateCacheKey(playerId: number, timestamp: number): string;
/**
