 ...
 */
export declare const TournamentState: {
 ...
 */
export declare const TeamTournamentPlayerListType: {
    readonly REGISTRATION_TEAMS: 1;
    readonly RATINGLIST_TEAMS: 2;
    readonly TEAM_TEAMS: 3;
};
/**
 ...
 */
export declare const PairingSystem: {
    readonly BERGER: 1;
    readonly MONRAD: 2;
    readonly NORDIC: 3;
    readonly FIDE_SWISS: 4;
    readonly ARENA: 5;
};
 ...
 * value is `BUCHHOLZ` (2).
 */
export declare const TiebreakSystem: {
    readonly UNSET: -1;
    readonly SSF_BERGER: 1;
    readonly BUCHHOLZ: 2;
    readonly SSF_BUCHHOLZ: 3;
    readonly MEDIAN_BUCHHOLZ: 4;
    readonly PROGRESSIVE: 5;
    readonly ALLSVENSKAN: 6;
    readonly FIDE_BUCHHOLZ_2024: 7;
};
 ...
 */
export declare function getTiebreakSystemName(tiebreakSystem: number): string;
/**
 ...
 */
export declare const Schack4anTeamPointSystem: {
    readonly S4_NORMALIZED: 1;
    readonly NORMAL: -1;
    readonly LEGACY_DEFAULT: 10;
};
 ...
 */
export declare function isLooseTeamTournament(playerListType: number): boolean;
/**
 ...
 */
export declare function isTeamTournament(type: number): boolean;
/**
 ...
 */
export declare function isTeamPairing(type: number): boolean;
/**
 ...
 */
export declare function isSchackfyran(type: number): boolean;
/**
 ...
 */
export declare function isSchackfyranLike(type: number, groupPointSystem: number): boolean;
/**
...
export type TournamentStatusSource = {
    ...
    roundResults?: ReadonlyArray<unknown>;
} | {
    tournament?: TournamentDto;
    group: TournamentClassGroupDto;
    roundResults?: ReadonlyArray<unknown>;
